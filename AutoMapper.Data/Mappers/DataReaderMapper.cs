    ...
    public class DataReaderMapper : IObjectMapper
    {
        ...
        public object Map(ResolutionContext context)
        {
            if (IsDataReader(context.Types))
            {
                ...
                var results = MapDataReaderToEnumerable(context, context.Engine, destinationElementType, YieldReturnEnabled);
        ...
        private static Build CreateBuilder(Type destinationType, IDataRecord dataRecord)
        {
            ...
            if (BuilderCache.TryGetValue(builderKey, out builder))
            {
                return builder;
            }
            ...
            BuilderCache[builderKey] = builder;
            return builder;
        }
        ...
        private static CreateEnumerableAdapter GetDelegateToCreateEnumerableAdapter(Type elementType)
        {
            ...
            if (EnumerableAdapterCache.TryGetValue(elementType, out builder))
            {
                return builder;
            }
            ...
            EnumerableAdapterCache[elementType] = builder;
            return builder;
        }
